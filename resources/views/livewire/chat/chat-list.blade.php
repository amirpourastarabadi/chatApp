<div x-data="{type:'all',query:@entangle('query')}" class="flex flex-col transition-all h-full overflow-hidden">
    ...
    <main class=" overflow-y-scroll overflow-hidden grow  h-full relative " style="contain:content">
        ...
        <ul class="p-2 grid w-full spacey-y-2">
            ...
            <li id="conversation-1" class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 bg-gray-100/70">
                ...
                <aside class="grid grid-cols-12 w-full">
                    ...
                    <a href="#" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                        ...
                        <div class="flex justify-between w-full items-center">
                            ...
                            <small class="text-gray-700">3d</small>
